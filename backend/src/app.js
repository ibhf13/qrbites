...
app.use('/api/restaurants', addUserRestaurants, restaurantRoutes)
app.use('/api/menus', addUserRestaurants, menuRoutes)
app.use('/api/menu-items', addUserRestaurants, menuItemRoutes)
