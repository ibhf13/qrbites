...
describe('QR Code Service', () => {
    ...
    describe('generateQRCode', () => {
        ...
        it('should create the QR code directory if it does not exist', async () => {
            fs.existsSync.mockReturnValue(false)

            const url = 'https://example.com/menu/123'
            await generateQRCode(url)

            expect(fs.mkdirSync).toHaveBeenCalledWith(dirs.qrcode, { recursive: true })
        })
    ...
    describe('getQRCodeUrl', () => {
        it('should return null if filename is not provided', () => {
            ...
            const result2 = getQRCodeUrl(undefined)
            expect(result2).toBeNull()

            const result3 = getQRCodeUrl('')
    ...
    describe('generateMenuQRCode', () => {
        ...
        it('should work with real menu and restaurant IDs from database', async () => {
            // Create test restaurant and menu
